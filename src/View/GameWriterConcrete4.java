...
public class GameWriterConcrete4 extends Application {
	static GameWriterConcrete4 myWriter;
	private static final String FILE_DESTINATION = "src/xml/TowerOffense.xml";
	GameObject hero;
...
//		}
	...
	public GameWorld makeWorld() {
		...
		List<GridCell> towerPoints = new ArrayList<>();
		for(int i = 0; i<10; i++){
			for(int j = 0; j<10; j++){
				if(Math.random()<0)
					towerPoints.add(new GridCell(i,j));
			}
		}
...
//			g.getWeapon().setFiringRate(100);
	...
	public static void main(String[] args) {
		myWriter = new GameWriterConcrete4();
		myWriter.writeGame();
	}
